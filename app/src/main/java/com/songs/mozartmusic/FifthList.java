...
public class FifthList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifth_list);
        ...
        new FifthList.JSONTask().execute("http://188.166.91.187/Relaxation/Positive_Energy.json");
    ...
    */
    ...
    public class JSONTask extends AsyncTask<String,String,List<SongModel>> {
        ...
        protected void onPostExecute(List<SongModel> result){
            ...
            FifthList.SongAdapter adapter = new FifthList.SongAdapter(getApplicationContext(),R.layout.row,result);
