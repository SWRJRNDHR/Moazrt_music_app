...
public class EighthList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eighth_list);
        ...
        new EighthList.JSONTask().execute("http://188.166.91.187/Relaxation/Nature.json");
    ...
    */
    ...
    public class JSONTask extends AsyncTask<String,String,List<SongModel>> {
        ...
        protected void onPostExecute(List<SongModel> result){
            ...
            EighthList.SongAdapter adapter = new EighthList.SongAdapter(getApplicationContext(),R.layout.row,result);
