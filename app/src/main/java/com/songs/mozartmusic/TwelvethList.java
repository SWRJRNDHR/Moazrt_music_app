...
public class TwelvethList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twelveth_list);
        ...
        new TwelvethList.JSONTask().execute("http://188.166.91.187/Relaxation/Om.json");
    ...
    */
    ...
    public class JSONTask extends AsyncTask<String,String,List<SongModel>> {
        ...
        protected void onPostExecute(List<SongModel> result){
            ...
            TwelvethList.SongAdapter adapter = new TwelvethList.SongAdapter(getApplicationContext(),R.layout.row,result);
