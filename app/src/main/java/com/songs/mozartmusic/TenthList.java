...
public class TenthList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_list);
        ...
        new TenthList.JSONTask().execute("http://188.166.91.187/Relaxation/Flute.json");
    ...
    */
    ...
    public class JSONTask extends AsyncTask<String,String,List<SongModel>> {
        ...
        protected void onPostExecute(List<SongModel> result){
            ...
            TenthList.SongAdapter adapter = new TenthList.SongAdapter(getApplicationContext(),R.layout.row,result);
