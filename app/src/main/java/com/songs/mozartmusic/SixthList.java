...
public class SixthList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sixth_list);
        ...
        new SixthList.JSONTask().execute("http://188.166.91.187/Relaxation/Workout.json");
    ...
    */
    ...
    public class JSONTask extends AsyncTask<String,String,List<SongModel>> {
        ...
        protected void onPostExecute(List<SongModel> result){
            ...
            SixthList.SongAdapter adapter = new SixthList.SongAdapter(getApplicationContext(),R.layout.row,result);
