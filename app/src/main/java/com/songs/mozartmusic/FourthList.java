...
public class FourthList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FourthList.JSONTask().execute("http://188.166.91.187/Relaxation/Meditation.json");
    ...
    */
    ...
    public class JSONTask extends AsyncTask<String, String, List<SongModel>> {
        ...
        protected void onPostExecute(List<SongModel> result) {
            ...
            FourthList.SongAdapter adapter = new FourthList.SongAdapter(getApplicationContext(), R.layout.row, result);
...
*/
    ...
    public void ringtone(){
        ...
        Uri uri = Uri.parse(CurrentSongUrl);
