...
public class NinthList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ninth_list);
        ...
        new NinthList.JSONTask().execute("http://188.166.91.187/Relaxation/Piano.json");
    ...
    */
    ...
    public class JSONTask extends AsyncTask<String,String,List<SongModel>> {
        ...
        protected void onPostExecute(List<SongModel> result){
            ...
            NinthList.SongAdapter adapter = new NinthList.SongAdapter(getApplicationContext(),R.layout.row,result);
