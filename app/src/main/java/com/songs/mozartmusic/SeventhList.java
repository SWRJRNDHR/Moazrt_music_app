...
import com.songs.mozartmusic.models.SongModel;
...
/**
 * Created by Swaraj on 1/7/2018.
 */

public class SeventhList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seventh_list);
        ...
        new SeventhList.JSONTask().execute("http://188.166.91.187/Relaxation/Happiness.json");
    ...
    */
    ...
    public class JSONTask extends AsyncTask<String,String,List<SongModel>> {
        ...
        protected void onPostExecute(List<SongModel> result){
            ...
            SeventhList.SongAdapter adapter = new SeventhList.SongAdapter(getApplicationContext(),R.layout.row,result);
